 ...
 *
 * Allows school administrators to manage pending user access requests.
 *
...
async function getPendingUsers(schoolId: string, search?: string) {
  const where: {
    schoolId: string;
    status: UserStatus;
    OR?: Array<{
...
async function getSchoolsForFilter(adminSchoolId: string) {
...
export default async function AdminApprovalsPage({
  ...
  // Step 4: Fetch pending users for admin's school only
  const pendingUsers = await getPendingUsers(admin.schoolId, search);
  const schools = await getSchoolsForFilter(admin.schoolId);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Manage pending access requests for your school
          </p>
        </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900">
                {pendingUsers.filter((u) => u.role === Role.TEACHER).length}
              </p>
        ...
        <div className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900">
                {pendingUsers.filter((u) => u.role === Role.STUDENT).length}
              </p>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-start gap-3">
        ...
        <div>
          <p className="font-medium text-blue-900">Approval Guidelines</p>
          <ul className="text-sm text-blue-700 mt-1 space-y-1">
            <li>
              • Verify the user&apos;s identity and role before approving
            </li>
            <li>• Teachers and students require school association</li>
            <li>• Rejected users can request access again with different email</li>
