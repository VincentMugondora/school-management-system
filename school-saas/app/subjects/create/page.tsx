...
import { createSubject } from '@/app/actions/teacher.actions';
...
const navItems = [
  ...
  { icon: BookOpen, label: 'Subjects', href: '/dashboard/admin/subjects', active: true },
      ...
      <main className="flex-1 ml-64">
        ...
        <header className="bg-white px-8 py-4 flex items-center justify-between border-b border-gray-100">
          <div className="flex items-center gap-4">
            <Link href="/dashboard/admin/subjects" className="p-2 hover:bg-gray-100 rounded-xl">
              <ArrowLeft className="w-5 h-5 text-gray-600" />
            </Link>
            <div>
              <h1 className="text-xl font-bold text-gray-800">Add New Subject</h1>
        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit} className="max-w-3xl">
            <div className="bg-white rounded-2xl shadow-sm p-6 mb-6">
              <h2 className="text-lg font-semibold text-gray-800 mb-4">Subject Information</h2>
