...
import { createClass } from '@/app/actions/teacher.actions';
      ...
      <main className="flex-1 ml-64">
        ...
        <header className="bg-white px-8 py-4 flex items-center justify-between border-b border-gray-100">
          <div className="flex items-center gap-4">
            <Link href="/dashboard/admin/classes" className="p-2 hover:bg-gray-100 rounded-xl">
          ...
          <form onSubmit={handleSubmit} className="max-w-3xl">
            <div className="bg-white rounded-2xl shadow-sm p-6 mb-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Stream/Section</label>
                  <input
                    type="text"
                    name="stream"
